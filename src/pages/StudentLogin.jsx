  ...
  return (
    <div className="main-app-container">
      ...
      <div className="glass-card text-center">
        ...
        <p className="text-white-50 small mb-4">Portal Access</p>

        <div className="mb-3 text-start">
          <label className="text-white-50 small ms-2">Student ID</label>
          <input type="text" className="form-control bg-transparent text-white border-secondary shadow-none" placeholder="e.g. 20000123" />
        </div>
